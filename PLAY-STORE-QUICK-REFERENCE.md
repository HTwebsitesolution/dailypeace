...
All files are relative to: `c:\dailypeace-starter\dailypeace\`

### App Icon
- **Path:** `assets/branding/icons/icon-android.png`
- **Size:** 512×512 pixels
- **Format:** PNG

### Feature Graphic
- **Path:** `assets/branding/feature graphic - dailypeace.png`
- **Size:** 1024×500 pixels
- **Format:** PNG

### Screenshots
- **Screenshot 1:** `play-store-screenshot-1-home.png` (360×800)
- **Screenshot 2:** `play-store-screenshot-2-home-alt.png` (360×800)

### App Bundle (AAB)
- **Build command:** `eas build --platform android --profile production`
- **Download from:** EAS Build dashboard after build completes
- **Format:** `.aab` file
...
## 📝 Full Description (Copy Entire Block)
...
- [ ] App icon file located
- [ ] Feature graphic file located
- [ ] 2 screenshots ready
- [ ] All text content copied (above)
- [ ] Privacy policy URL verified accessible
- [ ] Followed step-by-step guide: `PLAY-STORE-STEP-BY-STEP.md`
...
- **Privacy Policy:** https://dailypeace.life/privacy-policy
- **Full Step-by-Step Guide:** See `PLAY-STORE-STEP-BY-STEP.md`

---

**Quick Start:** Open `PLAY-STORE-STEP-BY-STEP.md` and follow the steps in order!
